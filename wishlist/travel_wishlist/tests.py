...
class TestHomePage(TestCase):
    def test_home_page_shows_only_empty_list_message(self):
...
class TestVisitedPlaceListEmpty(TestCase):

    def test_visited_page_shows_correct_empty_database_message(self):

        response = self.client.get(reverse('places_visited'))
        self.assertContains(response, 'You have not visited any places yet!')

class TestVisitedPlaceListNotEmpty(TestCase):
    fixtures = ['test_places']
    
    def test_visited_places_contains_visited_places(self):
        response = self.client.get(reverse('places_visited'))
